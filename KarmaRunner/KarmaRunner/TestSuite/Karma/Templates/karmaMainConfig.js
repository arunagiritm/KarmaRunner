...
module.exports = function(config) {
  config.set({
   ...
   //Karma plugins to report results in junit xml format and HTML format.
    ...
    junitReporter: {
    //   suite: 'unit',
      outputFile: 'dist/reports/testing/unit/xml/karma-unit-test-report.xml'
    },
    // HTML format
    htmlReporter: {
      outputFile: 'dist/reports/testing/unit/html/karma-unit-test-report.html'
    },
   ...
   browsers: ['Firefox'],
    ...
    coverageReporter: {
      reporters: [
        { type : 'cobertura', dir:'dist/reports/testing/unit/coverage/cobertura'},
        { type : 'lcov', dir:'dist/reports/testing/unit/coverage/lcov'}
      ]
