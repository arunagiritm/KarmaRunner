...
//require('../../Karma/KarmaBuild/karmaRequireConfig.js');
require('../JSFiles/angular.js');
require('../JSFiles/angular-mocks.js');
...
function exdefine(a,b){
jid=a || 1;
jpid=b || 0;define(['angular', 'angular-mock'], function() {
	 ...
	 describe('#claims#dental#model -> basicLineFactory', function() {
		 ...
		 var appConfig, appUtil;
	        ...
	        xit('should create basicLineFactory', function() {
	        ...
	        xdescribe('basicLineFactory Validation', function() {
	        	var lineItem;
